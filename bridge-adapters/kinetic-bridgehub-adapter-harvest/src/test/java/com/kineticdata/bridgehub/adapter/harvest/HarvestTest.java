...
public class HarvestTest extends BridgeAdapterTestBase {
    ...
    public void test_search() throws Exception {
        ...
        request.setStructure("Projects");
        request.setFields(fields);
        request.setQuery("is_active=<%=parameter[\"Is Active\"]%>" + "&client_id=<%=parameter[\"Client Id\"]%>");
    ...
    public void test_user_dec_sort() throws Exception {
        ...
        request.setFields(fields);
        request.setQuery("per_page=<%=parameter[\"Per Page\"]%>" + "&is_active=<%=parameter[\"Is Active\"]%>");
